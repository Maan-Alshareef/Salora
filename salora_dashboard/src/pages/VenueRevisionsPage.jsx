...
const labels = { name_ar: "الاسم", name_en: "الاسم الإنكليزي", description_ar: "الوصف", city: "المدينة", address: "العنوان", latitude: "خط العرض", longitude: "خط الطول", capacity: "السعة", price_syp: "السعر بالليرة", price_usd: "السعر بالدولار", opening_hours: "أوقات العمل", amenities: "المزايا", policies: "السياسات", vendor_categories: "فئات الخدمات", event_types: "أنواع المناسبات", services: "الخدمات", images: "الصور", videos: "الفيديوهات" };
