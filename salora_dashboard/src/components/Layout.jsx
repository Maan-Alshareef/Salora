...
const adminLinks = [
  ...
  { path: "/admin/payments", label: "سجل المدفوعات", icon: "💳" },
  { path: "/admin/refunds", label: "الاستردادات", icon: "↩️" },
  { path: "/admin/commissions", label: "أرباح وعمولات Salora", icon: "💰" },
  { path: "/admin/payment-methods", label: "وسائل الدفع", icon: "🏦" },
...
const ownerLinks = [
  ...
  { path: "/owner/payout-accounts", label: "حسابات الاستلام", icon: "🏦" },
  { path: "/owner/services", label: "خدمات الصالة", icon: "🧩" },
  { path: "/owner/booking-settings-v2", label: "الساعات والعروض", icon: "⏱️" },
  { path: "/owner/working-hours", label: "التوافر وأوقات العمل", icon: "🗓️" },
...
export default function Layout({ children }) {
  ...
  const Sidebar = (
    <aside className="h-full w-72 p-5 bg-slate-950/80 border-l border-white/10 backdrop-blur-xl flex flex-col">
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100" dir="rtl">
      ...
      <div className="relative z-10 lg:pr-72">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-white/10 bg-slate-950/60 px-4 backdrop-blur-xl sm:px-8">
...
export function GlobalVenueInspector() {
  ...
  const details = [
    ...
    ["سعر الساعة", `${formatPricePair(globalViewVenue.hourlyPrice || globalViewVenue.hourly_price_usd || globalViewVenue.finalPrice || globalViewVenue.basePrice || globalViewVenue.price || 0, "", globalViewVenue.hourlyPriceSyp || globalViewVenue.hourly_price_syp || globalViewVenue.finalPriceSyp || globalViewVenue.priceSyp || 0)} / ساعة`],
