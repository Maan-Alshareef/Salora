      ...
      child: Column(
        ...
        children: [
          ...
          if (availability != null) ...[
            ...
            const SizedBox(height: 8),
            Text(
              'الطلب المعلّق يحجز الموعد مؤقتاً لمدة ${availability.holdHours} ساعة، والخادم يعيد التحقق عند التأكيد لمنع الحجز المزدوج.',
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: const Text(
            'عند الضغط على «إنشاء حجز» يُحجز الموعد مؤقتًا وتظهر لك وسائل الدفع وحسابات مالك الصالة فورًا. ارفع الإيصال، ثم يتحقق المالك منه ليصبح الحجز مؤكدًا نهائيًا.',
          ),
        ),
      ],
    );
